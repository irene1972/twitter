...
export class MiPerfil {
  ...
  async ngOnInit() {
    ...
    await fetch(`${environment.apiUrl}/usuarios/obtener/${this.usuarioLogueado.email}`)
    ...
    await fetch(`${environment.apiUrl}/imagenes/listar-por-usuario/${this.usuarioLogueado.id}`)
      .then(response => response.json())
      .then(data => {
        this.datos = data;
